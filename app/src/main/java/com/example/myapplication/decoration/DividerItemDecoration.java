...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private List<TimeZoneBean> mDatas;

    public DividerItemDecoration(Context context, List<TimeZoneBean> datas) {
...
//                if (null != mDatas.get(position).getIndexTag() && mDatas.get(position).getIndexTag().equals(mDatas.get(position + 1).getIndexTag())) {
